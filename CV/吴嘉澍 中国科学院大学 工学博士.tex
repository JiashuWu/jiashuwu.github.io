...
\textbf{已录用CCF-A类/JCR一区论文9篇}，IEEE/ACM Trans在投2篇。\textbf{发明专利授权8项}，在审11项。以下为部分代表论文。
...
\begin{enumerate}
  ...
  \textit{IEEE Internet of Things Journal} (\textbf{IEEE IoTJ}，JCR一区), 2023
  ...
  \textit{IEEE Transactions on Services Computing} (\textbf{IEEE TSC}，CCF-A类), 2023
  ...
  \textit{IEEE Internet of Things Journal} (\textbf{IEEE IoTJ}，JCR一区), 2022
  ...
  \textit{IEEE Transactions on Computers} (\textbf{IEEE TC}，CCF-A类), 2022
  ...
  \textit{Journal of Parallel and Distributed Computing} (\textbf{JPDC}，JCR一区), 2022
  ...
  在审，\textit{ACM Transactions on Internet Technology} (\textbf{ACM TOIT}，JCR一区), 2023

  \item HI-CPT: Towards Verifiable IoT Intrusion Detection under Data-scarce Heterogeneous Environment\\
  \textbf{Jiashu Wu}, Hao Dai, Yang Wang\textsuperscript{\Letter}, Kejiang Ye, Chengzhong Xu\\
  在审，\textit{IEEE Transactions on Cybernetics} (\textbf{IEEE TCYB}，JCR一区), 2023
\end{enumerate}
...
\begin{itemize}
  ...
  \item 关键技能包括科学问题研究、Python编程、特征工程、深度学习算法设计、算法性能评估、学术论文撰写。发表CCFA类、JCR一区论文5篇，专利4项。
\end{itemize}
...
\begin{itemize}
  \setlength\itemsep{2pt}
  \item 2023年中国科学院院长奖学金优秀奖\\（中科院研究生最高奖，前0.5\%）

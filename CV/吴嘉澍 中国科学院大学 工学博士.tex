...
\begin{enumerate}
  ...
  \textit{IEEE Internet of Things Journal} (\textbf{IEEE IoTJ}，JCR一区，清华B类), 2023
  ...
  \textit{IEEE Internet of Things Journal} (\textbf{IEEE IoTJ}，JCR一区，清华B类), 2022
  ...
  \textit{Journal of Parallel and Distributed Computing} (\textbf{JPDC}，JCR一区，CCF-B类), 2022
  ...
  在审，\textit{ACM Transactions on Internet Technology} (\textbf{ACM TOIT}，JCR一区，CCF-B类), 2023

  \item HI-CPT: Towards Verifiable IoT Intrusion Detection under Data-scarce Heterogeneous Environment\\
  \textbf{Jiashu Wu}, Hao Dai, Yang Wang\textsuperscript{\Letter}, Kejiang Ye, Chengzhong Xu\\
  在审，\textit{IEEE Transactions on Cybernetics} (\textbf{IEEE TCYB}，JCR一区，CCF-B类), 2023
\end{enumerate}

...
\begin{itemize}
  ...
  \item \textbf{技能与成果}：\textbf{网络流量数据分析、入侵检测、深度学习算法设计、特征工程、Python编程、算法性能评估、学术写作。发表CCF-A类/JCR一区论文6篇，专利4项。}
\end{itemize}
...
\textbf{已录用CCF-A类/JCR一区论文10篇}，在投IEEE/ACM Trans/CCF-A类论文3篇。\textbf{发明专利授权10项}，在审9项。\textbf{论文专利主题}：网络数据分析、迁移学习、IoT安全监测、数据缓存与存储等。以下为部分代表论文。

\begin{enumerate}
  \setlength\itemsep{1pt}
  \item Open Set Dandelion Network for IoT Intrusion Detection\\
  第一作者，\textit{ACM Transactions on Internet Technology}，(\textbf{ACM TIOT}，\textbf{JCR一区}，\textbf{IF=5.3})，2024

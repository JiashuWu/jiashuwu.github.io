...
\textbf{Project and Internship topics}: Network data analytics, transfer learning, intrusion detection, model caching optimisation, data stream analysis, secure and efficient data storage, etc. 

...
\textbf{Project and Internship topics}: Network data analytics, transfer learning, intrusion detection, data caching optimisation, data stream analysis, secure and efficient data storage, etc. 
...
\begin{itemize}
  ...
  \item \textbf{Skills \& Outcomes}: caching optimisation, theoretical analysis, data mining and analytics, Python programming. Published 2 CCF-A papers and 3 patents. 
\end{itemize}
...
\begin{itemize}
  \setlength\itemsep{1.8pt}
  \item Design a multi-indexing remote sensing data storage and analytics system based on HDFS. With low latency, the system benefits geospatial data storage and analytics, and is broadly applicable under various big data scenarios. 
